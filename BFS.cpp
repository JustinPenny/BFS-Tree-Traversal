...
Name: Justin Penny
Course: 3110 Summer
Assignment: Program 5 - Breadth First Search of a graph with adjacency list input
****************/

/* HOW TO RUN: This program must be run using redorectd file I/O. Example: ./a.out < graph1.txt */

/* OUTPUT FORMAT: This program will output the BFS of the graph every time. If the graph is disjointed, an error prints.
                  If there is not disjointed, the program will print outa message confirming so.*/
